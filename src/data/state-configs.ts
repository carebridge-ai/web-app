...
export const stateConfigs: Record<string, StateConfig> = {
  ...
  HI: { medicaidExpanded: true, medicaidExpansionDate: '2014-01-01', chipIncomeThreshold: 313, exchangeType: 'federal', exchangeUrl: 'https://www.healthcare.gov/' },
  ...
  IL: { medicaidExpanded: true, medicaidExpansionDate: '2014-01-01', chipIncomeThreshold: 318, exchangeType: 'federal', exchangeUrl: 'https://getcovered.illinois.gov/' },
  ...
  ME: { medicaidExpanded: true, medicaidExpansionDate: '2019-01-03', chipIncomeThreshold: 213, exchangeType: 'state', exchangeUrl: 'https://www.coverme.gov/' },
