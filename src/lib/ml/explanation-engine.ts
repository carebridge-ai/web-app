...
export async function generateExplanation(
  ...
  // Step 5: Combine deterministic viz data with LLM-generated radar chart
  const visualization: VisualizationDataset = {
    ...vizBase,
    radarChart: {
      dimensions: llmResult.radarDimensions,
      plans: llmResult.radarScores,
    },
  }

  return {
    narrative: llmResult.narrativeSummary,
    planExplanations: llmResult.planExplanations,
    visualization,
  }
}
